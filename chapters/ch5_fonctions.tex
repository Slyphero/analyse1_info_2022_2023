...
On a 
\begin{align*}
\lim_{x \to +\infty} f(x) = 7 \text{ puis } \lim_{x \to 7} g(x) = \sqrt{7} \implies \lim_{x \to +\infty} h(x) = \sqrt{7}
\end{align*}
\end{exemple}
...
\begin{align*}
\exists m \in \R, \exists M \in \R \text{ tels que } \forall x \in [a, b], m \leq f(x) \leq M \text{ et } \exists x_0 \in [a, b], f(x_0) = m, \exists x_1 \in [a, b], f(x_1) = M
\end{align*}
\end{theoreme}
\end{graybox}
